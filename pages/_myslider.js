                ...
                <div style={{ position: "relative", display: "flex", overflow: "hidden" }}>
                    <SliderTransition direction={state.direction} key={state.index}>
                        <div style={{ padding: "1rem" }}>
                            <div>
                                <h6>
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus ex nostrum
                                    impedit minima aspernatur nisi laudantium consequatur perspiciatis voluptate totam
                                    placeat, in non, quod quos et voluptas animi. Eius, harum?
                                </h6>
                            </div>
                            <div>
                                <h3 style={{ lineHeight: "30px" }}>{state.centerElement.para}</h3>
                            </div>
                            <div>
