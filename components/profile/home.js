...
import laptopimg from "../../public/images/centertile/index/download.png";

export default function Home(){
    return(

        <div
        className=" bg-[#272727] h-full w-full grid py-14 lg:p-5 container w-full rounded-lg items-center absolute lg:flex"
      >
