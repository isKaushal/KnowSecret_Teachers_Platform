...
export default function Sidebar() {
  ...
  return (
    <SibarWrap
    className=" rounded-lg overflow-hidden col-span-1 hidden lg:block lg:h-[100%] "
          ...
          <div className="w-full h-full">
            ...
            <div className="social-icons-wrap grid justify-center items-start mt-[60%] text-white h-[60%]">
              <a target="_blank"  href="https://www.instagram.com/test_and_track/">
                <BsInstagram className="custom-transition text-xl my-1 hover:text-[#ff9d00]" />
              </a>
              <a target="_blank"  href="https://mail.google.com/mail/u/0/#inbox?compose=CllgCJqbQxnhmZrNGvDbDlbnRWtCSCPsrZbkkrvCxWQQcmCzCVJPwjHkKzbqDJQMFrJSxnQlSgV">
                <MdAlternateEmail className="custom-transition text-xl my-1 hover:text-[#ff9d00]" />
              </a>
              <a target="_blank"  href="https://www.facebook.com/testntrack">
                <FaFacebookF className="custom-transition text-xl my-1 hover:text-[#ff9d00]" />
              </a>
              <a target="_blank"  href="https://www.linkedin.com/company/testntrack/?viewAsMember=true">
                <FaLinkedinIn className="custom-transition text-xl my-1 hover:text-[#ff9d00]" />
              </a>
              <a target="_blank"  href="https://twitter.com/testntrack">
                <BsTwitter className="custom-transition text-xl my-1 hover:text-[#ff9d00]" />
              </a>
              <a target="_blank"  href="https://www.pinterest.com/HybridExamSystem/">
                <FaPinterestP className="custom-transition text-xl my-1 hover:text-[#ff9d00]" />
              </a>
            </div>
          </div>
        </div>
